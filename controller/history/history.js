...
/**
 * @page ss.router.controller.history History Events
 * @parent ss.Router.Controller
 * @plugin ss/router/controller/history
 * The ss/router/controller/history plugin adds 
...
var keyBreaker = /([^\[\]]+)|(\[\])/g;
$.Class('SS.Router.Controller.History',{
    /**
     * @hide
    ...
    getData: function(path) {
        var search = SS.Router.Controller.History.prototype.search(path),
            digitTest = /^\d+$/;
...
jQuery(function($) {
    $(window).bind('hashchange',function() {
        var data = SS.Router.Controller.History.prototype.getData(location.href),
            folders = SS.Router.Controller.History.prototype.pathname(location.href) || 'index',
...
$.extend($.Controller.prototype, {
    /**
    * @parent ss.router.controller.history
    ...
    */
    pathData :function() {
        return SS.Router.Controller.getData(location.href);
    }
});
});